    ...
    AndroidView(
        ...
        update = { lineChart ->
            ...
            val dataSet = LineDataSet(values, "Label").apply {
                // 1. Chỉnh màu đường line thành "FA6F3E"
                color = Color.parseColor("#FA6F3E")
                ...
                setCircleColor(Color.parseColor("#FA6F3E")) // Màu trong nút
                ...
                drawable.colors = intArrayOf(Color.parseColor("#FFD29C"), Color.parseColor("#FFFFFF"))
...
fun LineChartPreview() {
    ...
    LineChartView(modifier = Modifier.size(380.dp, 180.dp), values = values)
}